...
MVP-сервис для подбора сноуборда по росту, весу, размеру ботинка и стилю катания.
...
- живой каталог моделей из PostgreSQL с импортом из CSV и магазинов
...
3. Импортируй свои данные из CSV:

```bash
npm run база:импорт-из-csv
```

4. Или обнови живой каталог из магазинов и сразу проверь качество данных:
